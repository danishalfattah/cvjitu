          ...
          <div className="prose max-w-none space-y-6">
            ...
            <section>
              ...
              <p className="text-gray-600 leading-relaxed">
                Dengan mengakses dan menggunakan layanan CVJitu, Anda menyatakan
                bahwa Anda telah membaca, memahami, dan menyetujui untuk terikat
                dengan syarat dan ketentuan ini. Jika Anda tidak menyetujui
                syarat ini, harap tidak menggunakan layanan kami.
              </p>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc list-inside text-gray-600 space-y-2 ml-4">
                <li>
                  Pembuatan CV profesional dengan template yang telah
                  dioptimalkan
                </li>
                <li>Analisis dan scoring CV otomatis dengan skala 1-100</li>
                <li>
                  Saran perbaikan berbasis AI untuk meningkatkan kualitas CV
                </li>
                <li>
                  Penyimpanan dan manajemen versi CV dalam repositori pribadi
                </li>
                <li>
                  Template yang kompatibel dengan sistem ATS (Applicant Tracking
                  System)
                </li>
              </ul>
            </section>
            ...
            <section>
              ...
              <p className="text-gray-600 leading-relaxed mb-3">
                Untuk menggunakan fitur lengkap CVJitu, Anda perlu membuat akun
                dengan informasi yang akurat dan terkini. Anda bertanggung jawab
                untuk:
              </p>
              <ul className="list-disc list-inside text-gray-600 space-y-2 ml-4">
                ...
                <li>
                  Memberitahu kami jika terjadi penggunaan akun yang tidak sah
                </li>
            ...
            <section>
              ...
              <ul className="list-disc list-inside text-gray-600 space-y-2 ml-4">
                ...
                <li>
                  Menggunakan layanan untuk spam atau aktivitas yang merugikan
                </li>
            ...
            <section>
              ...
              <p className="text-gray-600 leading-relaxed">
                Kami berkomitmen untuk melindungi privasi Anda. Informasi
                mengenai pengumpulan, penggunaan, dan perlindungan data pribadi
                Anda dijelaskan secara detail dalam Kebijakan Privasi kami.
                Dengan menggunakan layanan ini, Anda menyetujui praktik yang
                dijelaskan dalam kebijakan tersebut.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-gray-600 leading-relaxed">
                CVJitu dan semua kontennya, termasuk namun tidak terbatas pada
                teks, grafik, logo, ikon, gambar, dan perangkat lunak, adalah
                milik CVJitu atau pemberi lisensinya dan dilindungi oleh hukum
                kekayaan intelektual. CV yang Anda buat menggunakan platform
            ...
            <section>
              ...
              <p className="text-gray-600 leading-relaxed">
                CVJitu menyediakan layanan "sebagaimana adanya" tanpa jaminan
                eksplisit atau implisit. Kami tidak bertanggung jawab atas
                kerugian langsung, tidak langsung, insidental, atau
                konsekuensial yang timbul dari penggunaan layanan kami. Hasil
                analisis AI adalah rekomendasi dan tidak menjamin kesuksesan
            ...
            <section>
              ...
              <p className="text-gray-600 leading-relaxed">
                ...
                layanan kapan saja jika Anda melanggar syarat dan ketentuan ini
                atau melakukan aktivitas yang merugikan platform atau pengguna
                lain.
              </p>
            </section>
            ...
            <section>
              ...
              <div className="mt-3 p-4 bg-[var(--surface)] rounded-lg">
                <p className="text-gray-600">
                  <strong>Email:</strong> legal@cvjitu.com
                  <br />
