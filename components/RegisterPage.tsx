                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input
                      ...
                      className={`pl-10 border-2 ${errors.fullName ? 'border-red-500' : 'border-gray-300 focus:border-[var(--red-normal)]'}`}
                      disabled={isLoading}
                    />
                  </div>
                  {errors.fullName && (
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input
                      ...
                      className={`pl-10 pr-10 border-2 ${errors.confirmPassword ? 'border-red-500' : 'border-gray-300 focus:border-[var(--red-normal)]'}`}
                      disabled={isLoading}
                    />
                    <Button
                      type="button"
                ...
                <div className="space-y-2">
                  <div className="flex items-start space-x-3">
                    <Checkbox
                      ...
                      disabled={isLoading}
                    />
                    <Label htmlFor="agreeToTerms" className="text-sm text-gray-600 leading-relaxed flex-1">
